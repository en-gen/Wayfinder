...
{
    // ADO #58 - the wire projection of Wayfinder.Grains.Interfaces.Model.CaseFileItemTransition (CMMN
    // 1.1 Table 8.2's CaseFileItem transitions). A deliberate 1:1 mirror kept in lockstep with that
    // enum's members - see PlanItemTransition.cs's remarks for why Wayfinder.Contracts does not simply
