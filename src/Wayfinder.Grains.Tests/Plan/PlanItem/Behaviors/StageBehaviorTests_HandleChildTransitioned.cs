...
namespace Wayfinder.Grains.Tests.Plan.PlanItem.Behaviors
{
    public partial class StageBehaviorTests
    {
        ...
        public async Task HandleChildRepeated__When_ChildFound__Then_CreateRepeatInstance()
        {
            ...
            mockPlanItemGrain.Verify(x => x.DefineRepetition(testStore.CaseDefinitionId, pi, 1, stage.Id, definitionScope, It.IsAny<PlanItemDefinition>(), It.IsAny<CaseModelPin>()), Times.Once);
