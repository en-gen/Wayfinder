...
namespace Wayfinder.Benchmarks.Support
{
    ...
    // activated PlanItemGrain would supply. Only two members actually steer
    // PlanItemStateMachine's construction:
    //
    //   - PlanItemDefinition, which ConfigureFor switches on to pick between the CasePlanModel,
    //     Stage/Task, and Milestone/EventListener transition tables. A null or wrongly-typed
    ...
    //   - PlanItemState, which becomes the machine's initial state.
    //
