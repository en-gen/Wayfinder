...
namespace Wayfinder.Application.DependencyInjection
{
    ...
    {
        public static IServiceCollection AddFlowIdentity(this IServiceCollection services)
        {
            if (services is null) throw new ArgumentNullException(nameof(services));

            // Scoped to match ISender/the command/query handlers (AddFlowApplication) - one
